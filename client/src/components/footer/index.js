...
<footer className="footer-light">
    <div className="light-layout-white">
    ...
    <section className="section-b-space light-layout-white">
        <div className="container">
            <div className="row footer-theme partition-f">
                <div className="col-lg-4 col-md-6">
                    <div className="footer-contant" >
                        <div className="footer-logo">
                            <a href="#"><img src="#" alt="" className="img-fluid"/></a>
                        </div>
                    ...
                    <div className="sub-title">
                        ...
                        <div className="footer-contant" >
                            <ul className="contact-list">
                                <li><i className="fa fa-map-marker"></i>LOrem Ipsum Store, Demo store India 345-659</li>
                                <li><i className="fa fa-phone"></i>Call Us: 123-456-7898</li>
                                <li><i className="fa fa-envelope-o"></i>Email: <a href="#">care@tabadol.com</a></li>
            ...
            <div className="row">
                <div className="col-xl-6 col-md-6 col-sm-12">
                    <div className="footer-end">
                        <p><i className="fa fa-copyright" aria-hidden="true"></i> 2019-20 Tabadol All rights reserved</p>
                    </div>
                </div>
                {/* <div className="col-xl-6 col-md-6 col-sm-12">
